  ...
  return (
    <div className="group flex items-center justify-between p-4 hover:bg-pink-50/20 transition-all cursor-pointer">
      <div className="flex items-center gap-4">
        {/* Date */}
        <div className="h-12 w-12 rounded-xl bg-zinc-100 flex flex-col items-center justify-center text-zinc-500 border border-zinc-100 group-hover:border-pink-200 group-hover:bg-white transition-all">
      ...
      <div className="flex gap-6 items-center">
        ...
        <div className="text-right min-w-[85px]">
          {notInvolved ? (
            ...
            <>
              <p className={`text-[9px] uppercase tracking-widest font-bold ${isPayer ? "text-emerald-600/70" : "text-pink-600/70"}`}>
